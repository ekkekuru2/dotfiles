...

{
  ...
  boot.initrd.luks.devices."luks-339dbc40-f90c-45e3-a8eb-0e322f9baf6b".device = "/dev/disk/by-uuid/339dbc40-f90c-45e3-a8eb-0e322f9baf6b";
  networking.hostName = "lemp13"; # Define your hostname.

  # 20250504 Latest linux Kernel
  boot.kernelPackages = pkgs.linuxPackages_latest;


  nix.settings.auto-optimise-store = true;
  nix.settings.experimental-features = [ "nix-command" "flakes"];
  # 20260724 mutter 50.2 の SIGSEGV 対策として 50.3 に上げる overlay を入れていたが、
  # nixpkgs 側がすでに 50.4 まで進んで自前で修正を取り込み済みのため削除した。
  ...
  services.tlp = {
      ...
      settings = {
       ...
       START_CHARGE_THRESH_BAT0 = 0; # 電源に接続したらいつでも充電してほしい
